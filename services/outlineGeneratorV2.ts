...
- タイトルや見出しに「${currentYear}年」「${currentYear}年版」等の年表記を入れるのは、助成金・補助金・法改正・年次ランキングなど期間限定または定期更新される情報の場合のみ許可。一般的な知識・費用相場・施工手順など恒久的な内容には年表記を入れない
...
- 「${currentYear}年」の年表記は助成金・補助金・法改正・年次ランキングなど定期更新情報の場合のみ使用可。恒久的な内容には入れない`;
})()}
...
構成要件:
  タイトル:
    ...
    隅付き括弧【】ルール:
      ...
      - "タイトルの途中や最後での【】使用は禁止"
      - "【】内に年表記を入れるのは助成金・補助金・法改正など定期更新情報のみ"
      - "一般的な知識・費用相場・施工手順には年表記を入れない"
      - "良い例：【助成金対応】外壁塗装の費用を抑えるコツ"
      - "悪い例：【2026年】サイディングの外壁塗装で失敗しない方法"
    読みやすさルール:
