...
interface OutlineDisplayV2Props {
  ...
  availableMaterials?: ReferenceMaterial[]; // H2別セレクタに出す参考資料一覧
}
...
const OutlineDisplayV2: React.FC<OutlineDisplayV2Props> = ({ outline, keyword, onOutlineUpdate, onStartWriting, onStartWritingV1, onStartWritingV3, availableMaterials }) => {
